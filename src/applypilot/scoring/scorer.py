...
def _build_career_focus_block(career_focus: dict) -> str:
    ...
    return (
        ...
        "- Primary skills and target roles are the candidate's CURRENT strength. Weight them heavily.\n"
        "- Secondary skills are genuine but reflect the candidate's PAST, not their present practice.\n"
        "- HARD CAP: If the JD's PRIMARY duty is hands-on work in the candidate's secondary skills\n"
        "  (e.g. writing code daily, owning an engineering backlog as an IC), cap the score at 4-5\n"
        "  regardless of how strong the skill match looks. The candidate no longer does this work.\n"
        "- If secondary skills appear only as preferred/nice-to-have or as context (e.g. 'works with\n"
        "  engineering teams'), do NOT penalize — that is normal for the candidate's target roles.\n"
